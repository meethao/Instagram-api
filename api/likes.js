...
router.post('/', async (req, res) => {
  ...
  if (await checkLikesId(req.body.likeId) && await checkUserPostId(req.body.userId, req.body.postId)){
    ...
    res.status(500).send({
      error: "Error inserting like into DB. One user can’t like a post more than once."
    });
  }  
});
